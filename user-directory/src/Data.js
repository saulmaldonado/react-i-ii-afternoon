...
export default class Data extends Component{
    constructor(){
        ...
        this.newMode= this.newMode.bind(this)
    ...
    nextPerson(){
        if(this.state.personIndex < this.state.data.length - 1){
    ...
    deletePerson(){
      ...
      if(this.state.personIndex === this.state.data.length -1){
        ...
        this.state.data.splice((this.state.personIndex), 1)
    ...
    render(){
        return(
            <div>
                {!this.state.newMode && <InfoCard personId={this.state.data[this.state.personIndex]} dataLength={this.state.data.length} personIndex={this.state.personIndex + 1}/>}
                {this.state.newMode && <EmptyCard submitNewCard={this.submitNewCard}/> }
                <div className="nav-bar">
                <Previous previousPerson={this.previousPerson}/>
                <div id="button-container">
                    <div className="buttons" >Edit</div>
                    <Delete deletePerson={this.deletePerson}/>
                    <div className="buttons" onClick={this.newMode}>New</div>
                </div>
